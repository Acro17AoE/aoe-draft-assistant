...
- **Without login:** everything stays in your browser.
- **With login:** presets, results, and settings can sync; shared sessions let a team work on one board.

---

## Ranking

Civ priorities use **tiers only:** **S, A, B, C, D, F**. Order within a tier matters (left = stronger).
